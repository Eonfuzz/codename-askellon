...
function Trig_SetHatch_Actions()
    ...
    udg_hatch_entrance_names[9] = "|cff666633Service Tunnels|r"
    udg_hatch_entrance_names[10] = "|cffffff00Bridge|r"
    ...
    udg_hatch_exit_zones[9] = "BRIDGE"
    udg_hatch_exit_zones[10] = "BRIDGE_VENT"
end
