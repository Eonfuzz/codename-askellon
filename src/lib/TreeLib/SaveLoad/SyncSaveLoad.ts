...
import { EncodingBase64 } from "../Utility/Encoding/EncodingBase64";
import { EncodingHex } from "../Utility/Encoding/EncodingHex";
...
export class SyncSaveLoad {
    ...
    public read(filename: string, reader: player, onFinish?: (promise: FilePromise) => void): FilePromise {
        if (this.allPromises[GetPlayerId(reader)] == null) {
            ...
            Log.Warning("Trying to read file when file read is already busy.");
        }
