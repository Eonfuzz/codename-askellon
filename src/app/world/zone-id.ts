import { COL_VENTS, COL_CARGO_A, COL_FLOOR_1, COL_GOLD, COL_TEAL, COL_PURPLE } from "resources/colours";
...
ZONE_TYPE_TO_ZONE_NAME.set(ZONE_TYPE.BRIDGE_VENT, `${COL_VENTS}Bridge Vents|r`);
