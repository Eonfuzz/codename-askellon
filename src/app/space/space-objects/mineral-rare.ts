...
export class MineralRare extends SpaceObject {
    ...
    public loadAsUnit() {
        ...
        this.widget = new Unit(PlayerStateFactory.NeutralPassive, SPACE_UNIT_MINERAL_RARE, location.x, location.y, bj_UNIT_FACING) as Unit;
