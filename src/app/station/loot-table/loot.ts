...
import { BURST_RIFLE_ITEM_ID, SHOTGUN_ITEM_ID, LASER_ITEM_ID, ITEM_ID_NANOMED, AT_ITEM_DRAGONFIRE_BLAST, SNIPER_ITEM_ID, ITEM_ID_CRYO_GRENADE, ITEM_ID_REPAIR, ITEM_ID_25_COINS, ITEM_ID_EMO_INHIB } from "app/weapons/weapon-constants";
import { ITEM_WEP_MINIGUN, ITEM_TRIFEX_ID, ITEM_HELLFIRE_GRENADE, ITEM_BARRICADES, ITEM_SIGNAL_BOOSTER, ITEM_PLACEABLE_TURRET } from "resources/item-ids";
